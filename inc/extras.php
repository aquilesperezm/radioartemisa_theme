...
function newsmunch_site_slider_main() {
	...
	$newsmunch_slider_ttl			= get_theme_mod('newsmunch_slider_ttl','Noticias recientes');
...
function newsmunch_site_slider_middle() {
	$newsmunch_slider_mdl_ttl			= get_theme_mod('newsmunch_slider_mdl_ttl','Artículos Diarios');
...
function newsmunch_site_slider_right() {
	...
	$newsmunch_slider_right_ttl		= get_theme_mod('newsmunch_slider_right_ttl','Actualizaciones Diarias');
...
function newsmunch_list_top_tags($taxonomy = 'post_tag', $number = 8)
{
	if (is_front_page() || is_home()) {
		...
		if ((is_home() && ($newsmunch_display_top_tags=='post' || $newsmunch_display_top_tags=='front_post')) || (is_front_page() && ($newsmunch_display_top_tags=='front' || $newsmunch_display_top_tags=='front_post'))):
			...
			$newsmunch_top_tags_ttl 			= get_theme_mod('newsmunch_top_tags_ttl','Etiquetas Importantes');
			$newsmunch_hlatest_story_ttl 		= get_theme_mod('newsmunch_hlatest_story_ttl','Últimos Artículos');
